...
class Nivetha:
   ...
   dependents_l = '/html/body/div/div[1]/div[2]/div[2]/div/div/div/div[1]/div[2]/div[4]/a'
   add_l = '//*[@id="app"]/div[1]/div[2]/div[2]/div/div/div/div[2]/div[1]/div/button'
   name_l = '/html/body/div/div[1]/div[2]/div[2]/div/div/div/div[2]/div[1]/form/div[1]/div/div[1]/div/div[2]/input'
   name = 'murugesan'
   relationship_l = '/html/body/div/div[1]/div[2]/div[2]/div/div/div/div[2]/div[1]/form/div[1]/div/div[2]/div/div[2]/div/div/div[1]'
   relationship = '/html/body/div/div[1]/div[2]/div[2]/div/div/div/div[2]/div[1]/form/div[1]/div/div[2]/div/div[2]/div/div/div[1]'
   pspecify_l = '/html/body/div/div[1]/div[2]/div[2]/div/div/div/div[2]/div[1]/form/div[1]/div/div[3]/div/div[2]/input'
   pspecify = 'neighbour'
#    dob_l = '//*[@id="app"]/div[1]/div[2]/div[2]/div/div/div/div[2]/div[1]/form/div[2]/div/div/div/div[2]/div/div/i'
   dob_l ='/html/body/div/div[1]/div[2]/div[2]/div/div/div/div[2]/div[1]/form/div[2]/div/div/div/div[2]/div/div/input'
   dob = '2021-08-14'
   save_l = '/html/body/div/div[1]/div[2]/div[2]/div/div/div/div[2]/div[1]/form/div[3]/button[2]'
#    adddp_l ='//*[@id="app"]/div[1]/div[2]/div[2]/div/div/div/div[2]/div[2]/div/button'
   adddp_l = '/html/body/div/div[1]/div[2]/div[2]/div/div/div/div[2]/div[5]/div[1]/div/button'
#    cmnt_l = '//*[@id="app"]/div[1]/div[2]/div[2]/div/div/div/div[2]/div[5]/div/form/div[2]/div/div/div/div[2]/textarea'
   cmnt_l = '/html/body/div/div[1]/div[2]/div[2]/div/div/div/div[2]/div[5]/div/form/div[2]/div/div/div/div[2]/textarea'
   cmnt = 'hello!! how are you doing friend ?'
   savee_l = '/html/body/div/div[1]/div[2]/div[2]/div/div/div/div[2]/div[5]/div/form/div[3]/button[2]'
   ...
   def Addemployee(self):
        ...
        sleep(5)
        self.driver.find_element(by=By.XPATH, value=self.dependents_l).click()
        sleep(4)
        ...
        self.driver.find_element(by=By.XPATH, value=self.pspecify_l).send_keys(self.pspecify)
        self.driver.find_element(by=By.XPATH, value=self.dob_l).send_keys(self.dob)
        self.driver.find_element(by=By.XPATH, value=self.save_l).click()
        self.driver.find_element(by=By.XPATH, value=self.adddp_l).click()
        self.driver.find_element(by=By.XPATH, value=self.cmnt_l).send_keys(self.cmnt)
