...
class Nivetha:
   ...
   job_l = '//*[@id="app"]/div[1]/div[2]/div[2]/div/div/div/div[1]/div[2]/div[6]'
   ...
   def Addemployee(self):
        ...
        sleep(4)
        self.driver.find_element(by=By.XPATH, value=self.jd_l).click()
        self.driver.find_element(by=By.XPATH, value=self.jt_l).click()
        self.driver.find_element(by=By.XPATH, value=self.jc_l).click()
        self.driver.find_element(by=By.XPATH, value=self.su_l).click()
        self.driver.find_element(by=By.XPATH, value=self.location_l).click()
        self.driver.find_element(by=By.XPATH, value=self.es_l).click()
