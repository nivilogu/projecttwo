...
class Nivetha:
   ...
   ec_l = '/html/body/div/div[1]/div[2]/div[2]/div/div/div/div[1]/div[2]/div[3]'
   depend_l = '/html/body/div/div[1]/div[2]/div[2]/div/div/div/div[1]/div[2]/div[4]'
   immig_l = '/html/body/div/div[1]/div[2]/div[2]/div/div/div/div[1]/div[2]/div[5]'
   job_l = '/html/body/div/div[1]/div[2]/div[2]/div/div/div/div[1]/div[2]/div[6]'
   sal_l = '/html/body/div/div[1]/div[2]/div[2]/div/div/div/div[1]/div[2]/div[7]'
   tax_l = '/html/body/div/div[1]/div[2]/div[2]/div/div/div/div[1]/div[2]/div[8]'
   rep_l = '/html/body/div/div[1]/div[2]/div[2]/div/div/div/div[1]/div[2]/div[9]'
   qual_l = '/html/body/div/div[1]/div[2]/div[2]/div/div/div/div[1]/div[2]/div[10]'
   mem_l = '/html/body/div/div[1]/div[2]/div[2]/div/div/div/div[1]/div[2]/div[11]'
   ...
   def Addemployee(self):
        ...
        sleep(5)
        #self.driver.find_element(by=By.XPATH, value=self.pd_l).click()
     #    self.driver.find_element(by=By.XPATH, value=self.cd_l).click()
        sleep(3)
        self.driver.find_element(by=By.XPATH, value=self.ec_l).click()
        sleep(3)
        self.driver.find_element(by=By.XPATH, value=self.depend_l).click()
        sleep(3)
        self.driver.find_element(by=By.XPATH, value=self.immig_l).click()
        sleep(3)
        self.driver.find_element(by=By.XPATH, value=self.job_l).click()
        sleep(3)
        self.driver.find_element(by=By.XPATH, value=self.sal_l).click()
        sleep(3)
        self.driver.find_element(by=By.XPATH, value=self.tax_l).click()
        sleep(3)
        self.driver.find_element(by=By.XPATH, value=self.rep_l).click()
        sleep(3)
        self.driver.find_element(by=By.XPATH, value=self.qual_l).click()
        sleep(3)
        self.driver.find_element(by=By.XPATH, value=self.mem_l).click()
