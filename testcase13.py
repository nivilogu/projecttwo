...
class Nivetha:
   ...
   taxexemp_l = '//*[@id="app"]/div[1]/div[2]/div[2]/div/div/div/div[1]/div[2]/div[8]/a'
   fstatus_l = '/html/body/div/div[1]/div[2]/div[2]/div/div/div/div[2]/div[1]/form/div[1]/div/div[1]/div/div[2]/div/div/div[1]'
   fstatus = '/html/body/div/div[1]/div[2]/div[2]/div/div/div/div[2]/div[1]/form/div[1]/div/div[1]/div/div[2]/div/div/div[1]'
   fexemptions_l ='//*[@id="app"]/div[1]/div[2]/div[2]/div/div/div/div[2]/div[1]/form/div[1]/div/div[2]/div/div[2]/input'
   sstate_l = '//*[@id="app"]/div[1]/div[2]/div[2]/div/div/div/div[2]/div[1]/form/div[2]/div/div[1]/div/div[2]/div/div/div[1]'
   sstate = 'North Carolina'
   sstatus_l = '/html/body/div/div[1]/div[2]/div[2]/div/div/div/div[2]/div[1]/form/div[2]/div/div[2]/div/div[2]/div/div/div[1]'
   sstatus = '/html/body/div/div[1]/div[2]/div[2]/div/div/div/div[2]/div[1]/form/div[2]/div/div[2]/div/div[2]/div/div/div[1]'
   sexemptions_l = '//*[@id="app"]/div[1]/div[2]/div[2]/div/div/div/div[2]/div[1]/form/div[2]/div/div[3]/div/div[2]/input'
   unemp_l = '//*[@id="app"]/div[1]/div[2]/div[2]/div/div/div/div[2]/div[1]/form/div[2]/div/div[4]/div/div[2]/div/div/div[1]'
   unemp = 'California'
   work_l = '//*[@id="app"]/div[1]/div[2]/div[2]/div/div/div/div[2]/div[1]/form/div[2]/div/div[5]/div/div[2]/div/div/div[1]'
   work = 'Florida'
   save_l = '//*[@id="app"]/div[1]/div[2]/div[2]/div/div/div/div[2]/div[1]/form/div[3]/button'
   add_l = '/html/body/div/div[1]/div[2]/div[2]/div/div/div/div[2]/div[2]/div[1]/div/button'
   comment_l = '/html/body/div/div[1]/div[2]/div[2]/div/div/div/div[2]/div[2]/div/form/div[2]/div/div/div/div[2]/textarea'
   ...
   def Addemployee(self):
        ...
        sleep(5)
        self.driver.find_element(by=By.XPATH, value=self.taxexemp_l).click()
        sleep(5)
        self.driver.find_element(by=By.XPATH, value=self.fstatus_l).send_keys(self.fstatus)
        sleep(3)
        self.driver.find_element(by=By.XPATH, value=self.sstate_l).send_keys(self.sstate)
        sleep(3)
        self.driver.find_element(by=By.XPATH, value=self.sstatus_l).send_keys(self.sstatus)
        sleep(3)
        self.driver.find_element(by=By.XPATH, value=self.unemp_l).send_keys(self.unemp)
        sleep(3)
        ...
        self.driver.find_element(by=By.XPATH, value=self.comment_l).send_keys(self.comment)
